<%@ Page Language="C#" MasterPageFile="~/employee/employee.master" AutoEventWireup="true" CodeFile="viewrenewalpldetails.aspx.cs" Inherits="employee_viewrenewalpldetails" Title="Untitled Page" %>
...
<div class="entry">
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" 
        ...
        CellSpacing="2" style=" position :absolute; top: 525px; left: 313px;" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="dateofiss" HeaderText="dateofiss" 
                SortExpression="dateofiss" />
            <asp:BoundField DataField="typelicence" HeaderText="typeoflicence" 
