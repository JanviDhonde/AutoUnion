<%@ Page Language="C#" MasterPageFile="~/rto/rto.master" AutoEventWireup="true" CodeFile="pymentdetails.aspx.cs" Inherits="rto_pymentdetails" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="entry">
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" 
            ...
            CellSpacing="2" style=" position :absolute; top: 542px; left: 366px;" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
